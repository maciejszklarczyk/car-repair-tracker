...
- [x] 2.1 TypeScript compiles — 4e775c1
- [x] 2.2 Lint passes — 4e775c1

#### Manual

- [x] 2.3 POST with valid data creates row — 4e775c1
- [x] 2.4 POST with invalid data shows error — 4e775c1
- [x] 2.5 POST without auth rejected — 4e775c1
